...
from inventory.serializers import (
    ...
    InventoryCreateUpdateSerializer, InventoryCustomSerializer,
)
...
class InventoryCustomView(CustomResponseMixin, generics.ListAPIView):
    ...
    def list(self, request, *args, **kwargs):
        try:
            ...
            serializer = InventoryCustomSerializer(page, many=True)
            return self.custom_paginated_response(
                data_key='inventories',
                data=serializer.data,
                message='¡Inventarios encontradas con éxito!',
