...
export const fetchProfiles = (page: number) => async (dispatch: AppDispatch) => {
...
export const createProfile = (newProfile: Profile) => async (dispatch: AppDispatch) => {
...
export const updateProfile = (id: string, updatedProfile: Profile) => async (dispatch: AppDispatch) => {
    dispatch(updateProfileStart());
    try {
        const response = await axios.put(`${ACCOUNTS_URL}/profiles/${id}`, updatedProfile);
