    ...
    try {
      ...
      dispatch(
        fetchStudentsFailure({
          ...
          detailCode:
            error.response?.data.detail_code || 'FETCH_STUDENTS_ERROR',
        }),
      )
    }
  }
    ...
    try {
      ...
      dispatch(
        createStudentFailure({
          ...
          status: error.response?.status || 500,
          detailCode:
            error.response?.data.detail_code || 'CREATE_STUDENT_ERROR',
        }),
      )
    }
  }
    ...
    try {
      ...
      dispatch(
        updateStudentFailure({
          ...
          status: error.response?.status || 500,
          detailCode:
            error.response?.data.detail_code || 'UPDATE_STUDENT_ERROR',
        }),
      )
    }
  }
