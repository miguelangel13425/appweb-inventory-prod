    ...
    try {
      ...
      dispatch(
        fetchLocationsFailure({
          ...
          detailCode:
            error.response?.data.detail_code || 'FETCH_LOCATIONS_ERROR',
        }),
      )
    }
  }
      ...
      dispatch(
        fetchSimplifiedLocationsFailure({
          ...
          detailCode:
            ...
            'FETCH_SIMPLIFIED_LOCATIONS_ERROR',
        }),
      )
    }
  }
    ...
    try {
      ...
      dispatch(
        createLocationFailure({
          ...
          status: error.response?.status || 500,
          detailCode:
            error.response?.data.detail_code || 'CREATE_LOCATION_ERROR',
        }),
      )
    }
  }
    ...
    try {
      ...
      dispatch(
        updateLocationFailure({
          ...
          status: error.response?.status || 500,
          detailCode:
            error.response?.data.detail_code || 'UPDATE_LOCATION_ERROR',
        }),
      )
    }
  }
